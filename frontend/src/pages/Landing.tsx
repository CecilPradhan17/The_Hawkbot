    ...
    <section className="flex flex-col items-center px-4 sm:px-10 pb-16">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className={`absolute left-4 bottom-4 pointer-events-auto transition-opacity duration-200 ${isVideoHovered ? 'opacity-100' : 'opacity-0'}`}>
            <button
              onClick={() => {
                const v = videoRef.current
                if (!v) return
          ...
          <div className={`absolute left-1/2 transform -translate-x-1/2 bottom-4 pointer-events-auto transition-opacity duration-200 ${isVideoHovered ? 'opacity-100' : 'opacity-0'}`}>
            <button
              onClick={toggleMute}
