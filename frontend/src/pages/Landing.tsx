...
function VideoSection() {
  ...
  return (
    <section className="flex flex-col items-center px-4 sm:px-10 pb-16">
      <div className="w-full max-w-4xl rounded-2xl overflow-hidden shadow-2xl border border-slate-200">
        <video
          ref={videoRef}
          src="/demo.mp4"
          autoPlay
        ...
        {/* Custom controls */}
        <div className="bg-white flex items-center gap-3 px-4 py-3 border-t border-slate-100">
          {/* Play / Pause */}
          <button
            onClick={togglePlay}
            className="w-8 h-8 flex items-center justify-center rounded-full
                       bg-[#8A244B] text-white hover:opacity-90 active:scale-95
          ...
          <button
            onClick={replay}
            className="w-8 h-8 flex items-center justify-center rounded-full
                       border border-slate-200 text-slate-500 hover:border-[#8A244B]
                       hover:text-[#8A244B] active:scale-95 transition-all flex-shrink-0"
            aria-label="Replay"
          >
          ...
          <button
            ...
            className="text-xs font-medium px-3 py-1.5 rounded-lg border border-slate-200
                       text-slate-500 hover:border-[#8A244B] hover:text-[#8A244B]
